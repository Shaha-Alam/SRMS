...
<form class="needs-validation" action="{{route('task.store')}}" method="post">
  ...
  <div class="form-colom">
    ...
    <div class="">
      ...
      <input type="text" name="employee_email" class="form-control" id="validationCustom02" placeholder="Employee Email" required>
    </div>
  
    <div class="mb-3 form-group">
      <label for="validationCustom03">Product Name</label>
      <input type="text" name="product_name" class="form-control" id="validationCustom03" placeholder="Product Name" required>
    </div>
    ...
    <div class="mb-3 form-group">
      ...
      <input type="text" name="total_price" class="form-control" id="validationCustom04" placeholder="500Qty" required>
    </div>
    
    <div class="mb-3 form-group">
      <label for="validationCustom05">Target Quantity</label>
      <input type="text" name="target_quantity" class="form-control" id="validationCustom05" placeholder="5BDT" required>
    </div>

    <div class="mb-3 form-group">
      <label for="validationCustom05">Start Date</label>
      <input type="text" name="start_date" class="form-control" id="validationCustom05" placeholder="Start Date" required>
    </div>

    <div class="mb-3 form-group">
      <label for="validationCustom05">End Date</label>
      <input type="text" name="end_date" class="form-control" id="validationCustom05" placeholder="End Date" required>
    </div>
